...
| Method | Description |
|:---|:---|
| `max_depth`, `min_samples_split` | Manually restrict growth. |
...
3.  Enables **ruleset reduction** (e.g., by removing low-importance rules based-on *support*, *confidence*, or *lift*).
