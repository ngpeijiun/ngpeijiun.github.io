...
1.  Learning Outcomes
    ...
    -   Design applications using standard architectures based on business needs.
...
2.  Human Cognition
    ...
    -   Memory: Holding (short-term) and recalling (long-term) information.
...
3.  What are Cognitive Systems?
    ...
    -   Attention<br>
        Focuses on relevant information with *attention mechanisms* (e.g., transformer), *prompting*, and *saliency models* (in vision systems).
    -   Memory<br>
        Stores and retrieves information via *neural weights*, *knowledge graphs*, and *external databases*.
    -   Thought<br>
        Applies *symbolic reasoning*, *Bayesian inference*, and *planning and optimisation algorithms* to support problem-solving and decision-making.
    -   Language<br>
        Performs *NLU* for understanding input, *NLG* for generating output, and *semantic parsing* for system communication&mdash;now all unified through large language models (LLMs).
    -   Learning<br>
        Learns and adapts through techniques such as *supervised/unsupervised learning*, *reinforcement learning*, *fine-tuning*, *transfer learning* and *online learning*.
