...
<div class="badge">
  ...
  <span class="value">2025-06-06</span>
</div>
...
5.  **Language**<br>
    Performs **natural language understanding (NLU)** for understanding input, **natural language generation (NLG)** for generating output, and **semantic data structures** (JSON, XML) for system communication&mdash;now all unified through **large language models (LLMs)**.
6.  **Learning**<br>
