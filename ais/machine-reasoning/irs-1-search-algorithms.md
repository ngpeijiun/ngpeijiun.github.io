...
4.  AI Family
    ...
    -   **Predictive AI** → Forecasts outcomes (e.g., recommendation systems).
    -   **Generative AI** → Creates content (e.g., LLMs for text, GANs for images).
    -   **Multimodal AI** → Processes multiple data types (e.g., vision-language models).
...
5.  Sub-fields of AI
    ...
    -   Perception and Interaction (Visual, Auditory, and Textual Data)
...
7.  From Raw Data to Intelligence
    ...
    -   **Information Extraction** → Identify patterns in data.
    -   **Knowledge Formation** → Organise information into knowledge bases.
