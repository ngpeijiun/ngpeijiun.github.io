<h1 style="color: #ccc">Primay Mathematics 2</h1>
...
<script>
{
    const g = new MathGraph(document.getElementById('graph1'), {
    ...
    g.line({ x: 1, y: 1 }, { x: 6, y: 1 }, lineOpt)
    g.line({ x: 3, y: 6 }, { x: 3, y: 1 }, { ...lineOpt,
        arrow2: { type: 'rightAngle' },
    })
    g.text('A', { x: 0.5, y: 1 }, textOpt)
    g.text('B', { x: 6.5, y: 1 }, textOpt)
    g.text('J', { x: 3, y: 6.5 }, textOpt)
    g.text('K', { x: 3, y: 0.5 }, textOpt)
}
{
    const g = new MathGraph(document.getElementById('graph2'), {
        range: { x1: 0, x2: 7, y1: 0, y2: 7 },
        grid: { minor: { enabled: false } },
        axes: { enabled: false },
        border: { strokeStyle: '#42b983' },
    ...
    g.line({ x: 0, y: 4 }, { x: 3, y: 1 }, { ...lineOpt,
        arrow2: { type: 'rightAngle' },
    })
    g.line({ x: 3, y: 1 }, { x: 7, y: 5 }, lineOpt)
    g.text('A', { x: 0.5, y: 4.5 }, textOpt)
    g.text('B', { x: 3, y: 0.5 }, textOpt)
    g.text('C', { x: 6.5, y: 5.5 }, textOpt)
}
{
    const g = new MathGraph(document.getElementById('graph3'), {
        range: { x1: 0, x2: 7, y1: 0, y2: 7 },
        grid: { minor: { enabled: false } },
        axes: { enabled: false },
        border: { strokeStyle: '#42b983' },
