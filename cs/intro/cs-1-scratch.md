...
<div class="badge">
  ...
  <span class="value">2025-06-29</span>
</div>
...
**Sound** is stored by sampling analog audio signals and encoding them as binary values. Each sample can include data such as pitch (frequency), volume (amplitude), and duration. Like pixels in images, these values are stored in bytes and combined to reproduce music or speech. Additional data (e.g., instrument type) may also be included.
